...
const prefs2: GetFirstArg2<typeof createOrder> = {}
...
// type GetFirstArg2<T extends OneArgFn> = T extends OneArgFn
//   ? string[]
//   : never
type GetFirstArg2<T extends OneArgFn> = T extends OneArgFn<infer R> ? R : never
...
type GetFirstStringIshElement<T> = T extends readonly [infer S extends string, ..._: any[]]
  ? S
  : never
 ...
 */
type _ThisParameterType<T> = T extends (this: infer U, ...args: never) => any ? U : unknown
/**
